...
@Component({
  selector: 'app-addmanualallorders',
  templateUrl: './addmanualallorders.component.html',
  styleUrls: ['./addmanualallorders.component.css']
})
export class AddmanualallordersComponent implements OnInit {
  category1: any;
  ...
  constructor(public dialogRef: MatDialogRef<AddmanualallordersComponent>,private cc :ClientaddService,private clietlistService : ClientlistService,private productService : ProductService, private allordersService: AllordersService, private router: Router,private authService: AuthenticationService,
