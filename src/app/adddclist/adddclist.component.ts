...
@Component({
  selector: 'app-adddclist',
  templateUrl: './adddclist.component.html',
  styleUrls: ['./adddclist.component.css']
})
export class AdddclistComponent implements OnInit {
  ...
  changedvalue2(v)
  {
   ...
   console.log(v);
   this.allordersService.getDcadd(this.selectedclient,v.target.value).subscribe((result) => { 
    this.invoiceid1 = result[0];
    this.addAllorders.controls.balanceamount.setValue(this.invoiceid1.balanceamount);
    this.addAllorders.controls.advancegot.setValue(this.invoiceid1.advancegot);
    this.addAllorders.controls.finalinvoicebill.setValue(this.invoiceid1.finalinvoicebill);
    this.addAllorders.controls.totalproductstaken.setValue(this.invoiceid1.totalproductstaken);
     console.log(result);
   }, error => console.log(error));
